...
　スタッフは予定の提出と確認。店長は来週と再来週の全員の予定の確認が簡単にできます。<br>
 <img width="1004" alt="top-page 2020-10-26 21 01 57" src="https://user-images.githubusercontent.com/66765282/97170258-b312fd00-17ce-11eb-8b10-3dbef335c72d.png">
...
ユーザーは、①アプリを開き、②ログインし、③日付→勤務開始時間→勤務終了時間を設定し、④登録ボタンを押すだけで予定提出完了！
 ...
 #### ☆予定登録、編集、削除
![tourocu](https://user-images.githubusercontent.com/66765282/97168049-27e43800-17cb-11eb-9ff8-eaeaecfe57d7.gif)


 ＜とにかく使いやすく＞<br>
 スマホで使用することを意識してレイアウトを変更しました。<br>
 スマホ用の画像、配置にレスポンシブ対応済みです。(2020/10/26)<br>
 ...
 変更したい予定の変更ボタンを押すと、予定の変更が簡単にできます。<br>
 削除したい予定は、取消ボタンを押すだけで、削除できます。<br>
 ...
 出勤時間、休憩開始時間、休憩終了時間、退勤時間の順になるようにバリデーションをかけました。(2020/10/26)<br>
 

 管理者は、①アプリを開き、②(管理者権限で)ログインし、③予定確認ボタンを押すだけで、来週月曜日〜二週間分の全員の予定が確認できます。
 #### 管理者の予定閲覧
 ![admin](https://user-images.githubusercontent.com/66765282/97170270-bc03ce80-17ce-11eb-9d9c-83c25f93af56.gif)
...
### レスポンシブ対応
　画像とセレクトフォーム配置はできましたが(2020/10/26)、
 エラーメッセージや文字サイズに工夫が必要です。
...
### ユーザーが使いたくなるUI/UX
　好みの問題はあると思いますが、<br>
　思い切ってbackground-imageを導入して、ボタンなども透過させてみました。(2020/10/26)<br>
